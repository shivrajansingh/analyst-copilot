...
| --------------- | ------------------- |
| `page_index` | **74% exact, 90% within ±1** |
| `printed_page` | +1 on 50 blocks, −1 on 44 blocks — no consistent direction |
...
3. Split on `page-break-after: always`, matched on **`<hr>`, `<p>` or `<div>`** (and the CSS4 `break-after` spelling).
